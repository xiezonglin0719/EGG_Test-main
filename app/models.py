...
class Book:
    def __init__(self, isbn, name, author, press, category=0, intro=None, location=None, cover='lost'):
        self.isbn = isbn
        self.name = name
        self.author = author
        self.press = press
...
class Library:
    def __init__(self, book_id, isbn_id, location, status=0, borrower_id=None, start_date=0, end_date=0, readyto_borrow=0, readyto_return=0):
        ...
        self.readyto_borrow = readyto_borrow
        self.readyto_return = readyto_return

class Request:
    def __init__(self, id, book_id, opcode, requester, requestdate=0):
        self.id = id
        self.book_id = book_id
        self.opcode = opcode
...
class Want:
    def __init__(self, id, name, author, press, category=0, sale=None, requester=None, date=None):
        self.id = id
        self.name = name
        self.author = author
        self.press = press
...
class SysInfo:
    def __init__(self, id, maxuser=100, maxbook=5, maxtime=3):
        self.id = id
        self.maxuser = maxuser
        self.maxbook = maxbook
        self.maxtime = maxtime

class Statics:
    def __init__(self, mon, book_data=0, reader_data=0):
        self.mon = mon
